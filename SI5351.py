# SPDX-FileCopyrightText: Copyright 2023 Ted Dunning
# SPDX-FileCopyrightText: Adapted from Adafruit_CircuitPython_SI5351
...
Micropython module to control the SI5351 clock generator.  See
...
__repo__ = "https://github.com/tdunning/SI5351.git"
